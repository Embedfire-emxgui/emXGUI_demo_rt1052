...
/* Palette data */
static const NWORD NesPalette[ 64 ] =
{
...
//typedef struct 
//{
    //NBYTE buf[8*1024];//8KBµÄBANK
   // NWORD page;//»º³åÀï´æ´¢µÄÒ³ºÅ
//}BANKBUF;


void NES_Main(char *poi);
/* Menu screen */
int InfoNES_Menu(void);

/* Read ROM image file */
int InfoNES_ReadRom( char *pszFileName );
...
/* Get a joypad state */
void InfoNES_PadState( NDWORD *pdwPad1, NDWORD *pdwPad2, NDWORD *pdwSystem );
...
/*Sound IT*/
void InfoNES_SoundIT(void);

/* Sound Output 5 Waves - 2 Pulse, 1 Triangle, 1 Noise, 1 DPCM */
void InfoNES_SoundOutput(void);
