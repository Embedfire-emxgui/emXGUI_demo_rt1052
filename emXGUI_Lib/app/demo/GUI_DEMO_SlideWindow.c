...
u8 slogan_flag = 1;
 /*============================================================================*/
 /*============================================================================*/
const wchar_t string_slogan_gui[] = L" ■ NXP战略合作伙伴\r\n\r\n"\
...
const wchar_t string_slogan_board[] = L" ■ NXP战略合作伙伴\r\n\r\n"\
L" ■ 官网 : www.embedFire.com\r\n\r\n"\
L" ■ 论坛 : www.firebbs.cn\r\n\r\n"\
L" ■ 淘宝 : firestm32.taobao.com\r\n\r\n"\
L" ■ 微信公众号 : 公众号搜索“野火电子”，\r\n\r\n"\
...
const wchar_t header_slogan_board[] = L"野火 · i.MX RT教育专家";
...
//  old_font = SetFont(hdc, logoFont50);
...
void	GUI_DEMO_SlideWindow(void  *param)
