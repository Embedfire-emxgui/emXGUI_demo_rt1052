...
static struct __obj_list menu_list_1[] = {
	...
	L"图形加速器",		NULL, 	L"d", 	RGB_WHITE,			GUI_DEMO_Graphics_Accelerator,//(void(*)(HWND hwnd))GUI_DEMO_Graphics_Accelerator,
...
//    SetWindowLong(chwnd, GWL_USERDATA , (LONG)&bg_color );
		...
		SetWindowFont(wnd, ctrlFont64); //设置控件窗口字体.ID_EXIT
...
void GUI_App_Desktop(void *param)
{
	HWND	hwnd;
	WNDCLASS	wcex;
	MSG msg;
